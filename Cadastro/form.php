...
<div class="row">
   ...
   <div class="col-sm-4">
    ...
    <div class="mb-3 row">
   <div class="col-sm-4">
      <label class="lable">endereco: </label>
    </div>
     <div class="col-sm-8">
   ...
   <div class="col-sm-4">
    ...
    <div class="mb-3 row">
   <div class="col-sm-4">
      <label class="lable">Telefone No: </label>
    </div>
     <div class="col-sm-8">
   ...
   <div class="col-sm-4">
     ...
     <select name="category"  class="form-control" required>
      <option value="">Selecione </option>
        <option value="SC">Primaria</option>
        <option value="ST">Secundaria</option>
        <option value="OBC">Cambridge</option>
   ...
   <div class="col-sm-4">
     ...
     <select name="course" class="form-control" required>
      <option value="">Selecione o curso</option>
        <option value="Basic Computer">Alimo</option>
        <option value="Mathematics">Hifz</option>
        <option value="PHP Programming">Maktab</option>
     </select>
    </div>
    </div>
    </div>
